...
# NOTE: This endpoint should ideally be a POST request. However, it is set as a HEAD request
# as per the monitoring app rules to allow easy triggering.
@router.head(f"{Config.URL_PREFIX}/reset-db", name="reset_db")
async def reset_db():
    """
